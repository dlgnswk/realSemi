...
public class FrontController extends HttpServlet {
	...
	*/
		// *** 확인용 *** //
		// System.out.println("~~~ 확인용 => 서블릿 FrontController 의 inint(ServletConfig config) 메소드가 실행됨 ~~~");
		...
		try {
			...
			// fis 은 C:/NCS/workspace_jsp/MyMVC/src/main/webapp/WEB-INF/Command.properties 파일의 내용을 읽어오기 위한 용도로 쓰이는 객체이다.
			...
			*/
			...
			while(en.hasMoreElements()) {
				...
				*/
				...
				// System.out.println("### 확인용 value => " + className);
				/*
				...
				*/
				...
				if(className != null) {
					...
					/*
						~~~~ 확인용 obj =>test.controller.Test2Controller@312de9ff
						~~~~ 확인용 obj =>test.controller.Test1Controller@77afd9d6
					*/
					/*
