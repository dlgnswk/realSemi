...
<html lang="ko">
  ...
  <body id="container" style="overflow-x: hidden">
	...
	<%-- 사이드바 시작 --%>
		...
		<span><a class="nav-link header_footer_font" href="#"><img src="<%= ctxPath%>/images/장바구니.png" style="width:16px; height:16px;"><label>0</label></a></span>
		<div class="side_bar">	
	...
	<div id="category_container">
		<ul>
			<li id="total_view" name="total_view">
				<a href="#">
					<span class="category_img"><img src="<%= ctxPath%>/images/전체보기1.png" style="width:100px; height:100px;" class="cate_img" ></span>
			...
			<li id="perfume" name="perfume">
				<a href="#">
					<span class="category_img"><img src="<%= ctxPath%>/images/퍼퓸1.png" style="width:100px; height:100px;" class="cate_img" ></span>
			...
			<li id="perfume_bam" name="perfume_bam">
				<a href="#">
					<span class="category_img"><img src="<%= ctxPath%>/images/퍼퓸 밤1.png" style="width:100px; height:100px;" class="cate_img" ></span>
			...
			<li id="perfume_hand" name="perfume_hand">
				<a href="#">
					<span class="category_img"><img src="<%= ctxPath%>/images/퍼퓸 핸드1.png" style="width:100px; height:100px;" class="cate_img" ></span>
			...
			<li id="tube_hand" name="tube_hand">
				<a href="#">
					<span class="category_img"><img src="<%= ctxPath%>/images/튜브 핸드1.png" style="width:100px; height:100px;" class="cate_img" ></span>
