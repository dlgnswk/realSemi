...
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/css/jy/login/userLogin.css" />
...
<script type="text/javascript" src="<%= ctxPath%>/js/jy/login/userLogin.js"></script>
...
<div class="page__2-col--wide">
            ...
            <section class="login-section section--left">
                <div class="section__inner">
                    ...
                    <form class="account__form" name="flogin" action="https://www.tamburins.com/bbs/login_check.php" onsubmit="return flogin_submit(this);" method="post">
                        <input type="hidden" name="url" value="https%3A%2F%2Fwww.tamburins.com%2F">
                        <div class="input_item">
                            <div class="input_label">
                                <label class="input_label" for="login_id">아이디</label>
                            </div>
                            <div class="common_input">
                                <input type="text" name="mb_id" id="login_id" class="text" required="" size="20" maxlength="50">
                            </div>
                        </div>
                        <div class="input_item">
                            <div class="input_label">
                                <label class="input_label" for="login_pw">비밀번호</label>
                            </div>
                            <div class="common_input">
                                <input type="password" name="mb_password" id="login_pw" class="text" required="" size="20" maxlength="20">
                            </div>
                        </div>
						
						<div class="btn_wrap">
		                	<div class="common_btn" id="btn_login" onclick="login()"><button class="common_btn" type="button" >로그인</button></div>           
