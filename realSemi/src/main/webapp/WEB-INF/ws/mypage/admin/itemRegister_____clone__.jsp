...
<%-- 직접 만든 CSS --%>
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/css/mypage/mypageOrderDeliver.css" />
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/css/ws/mypage/mypageLeft_bar.css" />
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/css/mypage/itemRegister.css" />
...
<%-- 직접 만든 JS --%>
<script type="text/javascript" src="<%= ctxPath%>/js/mypage/itemRegister.js"></script>
	...
	<div id="member">
		...
		<div id="mypage_right">
			...
			<div id="board_content_container">		
				...
				<form name="itemInputFrm" action="#" method="POST" enctype="multipart/form-data">
					<table id="itemInputTbl">
						<tbody>
							...
							<tr class="Input_tr">
								...
								<%-- 제품사진 테이블 --%>
								<td rowspan="3"><div class="back_radius"><img class="bord_radius" src="<%= ctxPath%>/images/mypage/이미지아이콘.jpg" style="width:120px;height:120px;" onclick="goInput()"></div></td>
							</tr>
